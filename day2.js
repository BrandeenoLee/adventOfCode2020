...
function pswrd (string) {
  ...
  for (var i = 0; i < rules.length; i++) {
    ...
    var min = splitDash[0];
    var maxCharString = splitDash[1].split(' ')
    var max = maxCharString[0];
    var targetChar = maxCharString[1][0];
    var password = maxCharString[2];
    var charCount = 0;
...
console.log('expected: 2, actual:' , pswrd(input));
